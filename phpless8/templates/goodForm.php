<form class= "border p-2" method="post" action = "addGood" enctype="multipart/form-data">
  ...
  <label for="goodPriceDiscount">Цена со скидкой</label>
  <div class="input-group mb-3">
    <div class="input-group-prepend">
      <span class="input-group-text">$</span>
    </div>
    <input type="text" id="goodPriceDiscount" class="form-control" name = "discount_price" value = " <?= $good['discount_price'];?>" aria-label="Amount (to the nearest dollar)">
    <div class="input-group-append">
      <span class="input-group-text">.00</span>
    </div>
  </div>
